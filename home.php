    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Bienvenu sur La <?php echo $_SESSION['setting_name']; ?></h3>
                <hr class="divider my-4" />
                <div class="col-md-12 mb-2 text-left">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-center">Chercher une Offre</h4>
...
<section id="list">
    <div class="container mt-3 pt-2">
        <h4 class="text-center">Listes des Offres</h4>
        <hr class="divider">
        <?php
        ...
        ?>
            <div class="card vacancy-list" data-id="<?php echo $row['id'] ?>">
                <div class="card-body">
                    ...
                    <span><small>Besoin : <?php echo $row['availability'] ?></small></span>
                    <hr>
