			...
			<form action="" id="manage-status-cat">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"> Sauver</button>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center"> Categories de Statuts</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_scat" type="button" data-id="<?php echo $row['id'] ?>" data-status_label="<?php echo $row['status_label'] ?>"  >Editer</button>
										<button class="btn btn-sm btn-danger delete_scat" type="button" data-id="<?php echo $row['id'] ?>">Supprimer</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
