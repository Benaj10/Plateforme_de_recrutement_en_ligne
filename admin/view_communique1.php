...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <strong>Statut:</strong> <?php echo $statut; ?>
        ...
        <div class="col-md-6">
            ...
            <?php if (!empty($row['fichier_pdf'])): ?>
                <a href="download1.php?id=<?php echo $row['fichier_pdf'] ?>" target="_blank">Voir le PDF</a>
            <?php else: ?>
    ...
    <strong>Fichier PDF:</strong> 
    <?php if (!empty($row['fichier_pdf'])): ?>
        <a href="download1.php?id=<?php echo $id; ?>" target="_blank">Télécharger le PDF</a>
    <?php else: ?>
        Aucun fichier PDF associé.
    <?php endif; ?>
</div>
