		...
		<div class="card-body">
			<div class="row">
				<div class="col-lg-12">
					...
					<p class="text-center">
						<small>
							<i><b>Besoin : <larger><?php echo $availability ?></larger></b></i>
						</small>
						<?php if($status == 1): ?>
							<span class="badge badge-success pt-2">Embauche</span>
						<?php else: ?>
							<span class="badge badge-danger pt-2">Fermer</span>
						<?php endif; ?>
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
						<?php if($status == 1): ?>
							<button class="btn btn-block col-md-4 btn-primary btn-sm float-right" type="button" id="apply_now">Postuler Maintenant</button>

						<?php else: ?>
							<button class="btn btn-block col-md-4 btn-primary btn-sm float-right" type="button" disabled="" id="">Offre Fermée</button>
						<?php endif; ?>
...
<script>
	$('html, body').animate({
	  ...
	  $('#apply_now').click(function(){
        // Vérifier si l'utilisateur est connecté avant de lui permettre de postuler
